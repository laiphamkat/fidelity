...
public class enterUserFinancialDataMultipleTimes {
    
    private static def execute_functional_method(Map data) {
        
        "Step 1: Click on input userFinancialData (UserAge)"
        ...
        "Step 2: Enter input value in input userFinancialData (UserAge)"
        ...
        "Step 3: Click on input userFinancialData (UserAnnualIncome)"
        ...
        "Step 4: Enter input value in input userFinancialData (UserAnnualIncome)"
        ...
        "Step 5: Click on input userFinancialData (UserRetirementSavings)"
        ...
        "Step 6: Enter input value in input userFinancialData (UserRetirementSavings)"
        ...
        "Step 8: Click on input userFinancialData (UserMonthlySavings)"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_calculator_page/input_userFinancialData"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_calculator_page/input_userFinancialData', ['input_userFinancialData_internalLabel': data['input_userFinancialData_internalLabel_6']]))
        
        "Step 9: Enter input value in input userFinancialData (UserMonthlySavings)"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_calculator_page/input_userFinancialData"
        WebUI.setText(findTestObject('AI-Generated/Dynamic Objects/Page_calculator_page/input_userFinancialData', ['input_userFinancialData_internalLabel': data['input_userFinancialData_internalLabel_7']]), data['input_userFinancialData_3'])
    }
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        data['input_userFinancialData_3'] = testData.getValue('input_userFinancialData_3', rowIndex)
        ...
        data['input_userFinancialData_internalLabel_6'] = testData.getValue('input_userFinancialData_internalLabel_6', rowIndex)
        data['input_userFinancialData_internalLabel_7'] = testData.getValue('input_userFinancialData_internalLabel_7', rowIndex)
    ...
    private static def execute_without_data_source() {
        ...
        data['input_userFinancialData_3'] = 'default_data'
        ...
        data['input_userFinancialData_internalLabel_6'] = 'default_data'
        data['input_userFinancialData_internalLabel_7'] = 'default_data'
        execute_functional_method(data)
    }
