...
"Step 2: Click on link etfOptions (ETFsLookAtOurMixOf) -> Navigate to page 'investment etfs#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_homepage/link_etfOptions'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 2-Click on link etfOptions ETFsLookAtOurMixOf - Navigate to page investment etfs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on button read more - Navigate to page investor education what is an etf.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 6-Click on link investor education - Navigate to page educational content.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 7-Click on link six tips to make the most of your rrsp - Navigate to page insights articles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 8-Click on link rrsp 101 chinese version.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 11-Click on user role radio.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 12-Click on consent checkbox - Navigate to page .png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Explore ETF Education and Sign Up for Newsletter_visual_checkpoint')
