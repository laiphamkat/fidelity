...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 2-Click on aboutUsLink - Navigate to page informational pageaboutus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 3-Click on contactUsLink - Navigate to page contact pagecontact.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 4-Click on sendEmailButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 7-Click on span mediaResource - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Contact and Media Resource Navigation_visual_checkpoint')
