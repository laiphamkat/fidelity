...
"Step 4: Click on item investmentOptions (option2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_investment_finder/item_investmentOptions'))

WebUI.takeScreenshot(reportLocation + '/TC12/Step 4-Click on item investmentOptions option2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Search Investment Options and Verify Home Page_visual_checkpoint')
