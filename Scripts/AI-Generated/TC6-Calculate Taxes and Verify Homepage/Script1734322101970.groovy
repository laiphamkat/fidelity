...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 2-Click on residentProvinceTerritoryDropdown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 3-Click on yearSelector.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 4-Click on employmentIncomeSlider.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 5-Click on employmentIncomeSlider.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 6-Click on employmentIncomeInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 7-Click on interestIncomeInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 8-Enter input value in interestIncomeInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 9-Click on div TotalIncome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 10-Click on interestIncomeSlider.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 11-Click on taxCalculatorLink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 12-Click on residentProvinceTerritoryDropdown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 13-Click on employmentIncomeInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 14-Enter input value in employmentIncomeInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 15-Click on interestIncomeInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 16-Enter input value in interestIncomeInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 17-Click on dividendIncomeInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 18-Enter input value in dividendIncomeInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 19-Click on capitalGainsSlider.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 20-Click on capitalGainsFuture.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 21-Click on taxesPaidInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 22-Enter input value in taxesPaidInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 23-Click on div TotalDeductions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 24-Click on rrspContributionsInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 25-Enter input value in rrspContributionsInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 26-Click on fhsaContributionsInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 27-Click on calculateRefundButton - Navigate to page .png')

"Step 28: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Calculate Taxes and Verify Homepage_visual_checkpoint')
