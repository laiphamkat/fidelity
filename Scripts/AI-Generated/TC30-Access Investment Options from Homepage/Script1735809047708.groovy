...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 2-Click on body Homepage4 - Navigate to page investment options.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 3-Click on link investments.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 4-Click on link fd-megamenu--desktop  subject - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC30-Access Investment Options from Homepage_visual_checkpoint')
