...
WebUI.takeScreenshot(reportLocation + '/TC54/Step 2-Click on div HighchartsToolbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC54/Step 3-Click on div StockToolsWrapper.png')

"Step 4: Click on link language"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/products/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product_listing/link_language_1'))

WebUI.takeScreenshot(reportLocation + '/TC54/Step 4-Click on link language.png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC54-Verify Product Listing Navigation and Language_visual_checkpoint')
