...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 2-Click on md etfsCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on md ManagedPortfolios.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on checkbox product selection.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on checkbox managed portfolios.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 6-Click on md ManagedPortfolios2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7-Click on checkbox managed portfolios2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 8-Click on md ManagedPortfolios2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 9-Click on checkbox managed portfolios2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 10-Click on md ClearPathRetirement.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 11-Click on main InvestmentFinder - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Investment Finder with Managed Portfolios Selection_visual_checkpoint')
