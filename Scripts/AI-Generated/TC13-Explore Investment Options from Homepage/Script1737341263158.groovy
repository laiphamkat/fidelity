...
"Step 2: Click on body Homepage3 -> Navigate to page 'investment options#*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_homepage/body_Homepage3'))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 2-Click on body Homepage3 - Navigate to page investment options.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Explore Investment Options from Homepage_visual_checkpoint')
