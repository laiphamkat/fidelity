...
"Step 2: Interact with educational content repeatedly"

engageWithEducationalContent.execute()

"Step 3: Interact with educational content repeatedly"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 15-Click on link etfOverview ETFsOverview - Navigate to page investment etfs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 24-Click on readMoreButton - Navigate to page investor education what is an etf.png')
...
"Step 36: Click on link fundDetails (GetETFDetails) -> Navigate to page 'fund information#*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 36-Click on link fundDetails GetETFDetails - Navigate to page fund information.png')
...
"Step 46: Click on link fundDetails (GetFundDetails) -> Navigate to page 'fund information#*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/products/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_product_listing/link_fundDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_product_listing/link_fundDetails', ['link_fundDetails_internalRoleLinkName': link_fundDetails_internalRoleLinkName_1]))

WebUI.takeScreenshot(reportLocation + '/TC5/Step 46-Click on link fundDetails GetFundDetails - Navigate to page fund information.png')

"Step 47: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Interact with Educational Content and Fund Information_visual_checkpoint')
