...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on readMoreButton - Navigate to page investor education what is an etf.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 6-Click on investorEducationLink - Navigate to page educational content.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 7-Click on sixTipsForRRSP - Navigate to page insights articles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 8-Click on rrsp101ChineseLink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 9-Click on emailInputField.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 10-Enter input value in input email address.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 11-Click on userTypeSelection.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 12-Click on consentToReceiveCommunications - Navigate to page .png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Access Educational Content and Subscribe to Newsletter_visual_checkpoint')
