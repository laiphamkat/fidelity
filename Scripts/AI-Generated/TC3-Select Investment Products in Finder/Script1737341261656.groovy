...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 2-Click on md ETFs.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Select Investment Products in Finder_visual_checkpoint')
