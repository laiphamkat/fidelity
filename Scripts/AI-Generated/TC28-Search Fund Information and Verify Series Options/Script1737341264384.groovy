...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 2-Click on textbox search input.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 4-Enter input value in textbox search input.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 5-Click on link fidelity canadian asset allocation fund - Navigate to page product listingproducts.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 6-Click on combobox series b.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 7-Click on option series b - Navigate to page fund information.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 9-Click on link B - Navigate to page .png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC28-Search Fund Information and Verify Series Options_visual_checkpoint')
