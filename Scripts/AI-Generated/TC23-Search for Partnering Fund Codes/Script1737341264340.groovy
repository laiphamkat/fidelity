...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 2-Click on textbox search input.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 4-Enter input value in textbox search input.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 5-Click on link fund american equity - Navigate to page product pageproducts.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC23-Search for Partnering Fund Codes_visual_checkpoint')
