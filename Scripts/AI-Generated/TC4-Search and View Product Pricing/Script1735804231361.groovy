...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 2-Click on searchButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Enter input value in searchInputField.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on americanEquityLink - Navigate to page product pageproducts.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Search and View Product Pricing_visual_checkpoint')
