...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 2-Hover over link LifeExperiences.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 3-Click on viewAllButton - Navigate to page investing goals.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on signUpButton - Navigate to page newsletter pagenewsletter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 5-Click on emailInputField.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 6-Enter input value in emailInputField.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 7-Click on div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 8-Click on userTypeSelection.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 9-Click on userDescriptionSelector.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 10-Click on consentCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 11-Click on fidelityCanadaSustainabilityLink - Navigate to page informational pageaboutussustainability.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Sign Up for Newsletter from Investor Education Goals Page_visual_checkpoint')
