...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 4-Click on body EducationalContent - Navigate to page homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 5-Click on body Homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 6-Click on body Homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 7-Click on body Homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 8-Click on body Homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 9-Click on body Homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 10-Click on body Homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 11-Click on body Homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 12-Click on body Homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 13-Click on body Homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 14-Click on body Homepage.png')

"Step 15: Click on link etfInformation (ETFsLookAtOurMixOf) -> Navigate to page 'investment etfs#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_homepage/link_etfInformation'))

WebUI.takeScreenshot(reportLocation + '/TC23/Step 15-Click on link etfInformation ETFsLookAtOurMixOf - Navigate to page investment etfs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 16-Click on body ETFsPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 17-Click on body ETFsPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 18-Click on body ETFsPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 19-Click on body ETFsPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 20-Click on body ETFsPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 21-Click on body ETFsPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 22-Click on body ETFsPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 23-Hover over div object.png')

"Step 24: Click on readMoreButton -> Navigate to page 'investor education what is an etf#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_investment_etfs/readMoreButton'))

WebUI.takeScreenshot(reportLocation + '/TC23/Step 24-Click on readMoreButton - Navigate to page investor education what is an etf.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 25-Click on body WhatIsETF.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 26-Click on body WhatIsETF.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 27-Click on body WhatIsETF.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 28-Click on body WhatIsETF.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 29-Click on link fd-megamenu--desktop  subject - Navigate to page generic pagepriceandperformance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 30-Click on body GenericPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 31-Click on body GenericPage.png')

"Step 32: Hover over tr object"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/priceandperformance?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_generic_page/tr_object'))

WebUI.takeScreenshot(reportLocation + '/TC23/Step 32-Hover over tr object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 33-Click on link ViewFund - Navigate to page product listingproducts.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 34-Click on div HighchartsToolbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 35-Click on div StockToolsWrapper.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 36-Click on link fundFacts GetETFFacts - Navigate to page fund information.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 37-Click on combobox all sales options.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 38-Click on option dropdown item.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 39-Click on body FundInformation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 40-Click on body FundInformation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 41-Click on body FundInformation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 42-Click on body FundInformation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 43-Click on link fd-megamenu--desktop  subject - Navigate to page generic pagepriceandperformance.png')

"Step 44: Hover over tr object2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/priceandperformance?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_generic_page/tr_object2'))

WebUI.takeScreenshot(reportLocation + '/TC23/Step 44-Hover over tr object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 45-Click on link view fund - Navigate to page product listingproducts.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 46-Click on link fundFacts GetFundFacts - Navigate to page fund information.png')

"Step 47: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC23-Interact with Educational Content and Fund Information_visual_checkpoint')
