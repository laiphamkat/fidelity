...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 2-Click on link welcomeMessage WelcomeToFidelity - Navigate to page homepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 3-Click on investmentGoalsLink - Navigate to page investor education investing goals.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 4-Hover over link Retirement.png')

"Step 5: Click on button viewAllEducationOptions (ViewAllRetirement) -> Navigate to page 'investing goals#*/*/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 5-Click on button viewAllEducationOptions ViewAllRetirement - Navigate to page investing goals.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 6-Click on proxyVotingLink - Navigate to page generic proxyproxy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 7-Click on article Generic.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 8-Click on article Generic.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 9-Click on div Core.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 10-Click on article Generic.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 11-Click on div GuidelinesGlossary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 12-Click on div Core.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 13-Click on item Search.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 14-Click on searchButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 15-Click on searchInputField.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 16-Enter input value in searchInputField2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 17-Click on div CloseSubmitSearch.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 18-Click on closeButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 19-Click on article Generic - Navigate to page .png')

"Step 20: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC26-Explore Proxy Voting and Educational Articles_visual_checkpoint')
