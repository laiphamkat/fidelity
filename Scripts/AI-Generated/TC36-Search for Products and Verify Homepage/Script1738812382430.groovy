...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 2-Enter input value in input Search.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 3-Enter input value in input Search.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 4-Click on button SubmitSearch - Navigate to page search resultscontentsearch-resultshtml.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 5-Click on atomic object - Navigate to page productproducts.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 6-Click on link GlobalInvestmentNetwork - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC36-Search for Products and Verify Homepage_visual_checkpoint')
