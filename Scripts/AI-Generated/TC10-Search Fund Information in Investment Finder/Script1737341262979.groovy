...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 2-Click on fundSearchInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 3-Enter input value in fundSearchInput2.png')

"Step 4: Click on item option (Option)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_investment_finder/item_option'))

WebUI.takeScreenshot(reportLocation + '/TC10/Step 4-Click on item option Option.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Search Fund Information in Investment Finder_visual_checkpoint')
