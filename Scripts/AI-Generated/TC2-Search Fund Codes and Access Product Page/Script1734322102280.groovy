...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 2-Click on fundSearchInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 3-Hover over tr object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 4-Enter input value in fundSearchInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 5-Click on americanEquityLink - Navigate to page product pageproducts.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 6-Click on priceTab - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Search Fund Codes and Access Product Page_visual_checkpoint')
