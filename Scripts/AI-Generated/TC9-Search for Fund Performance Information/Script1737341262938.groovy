...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 2-Click on textbox search input.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Enter input value in textbox search input.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 5-Click on link american equity - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Search for Fund Performance Information_visual_checkpoint')
