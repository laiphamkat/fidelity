...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 2-Click on link investing for beginners - Navigate to page investor education investing beginners.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 6-Click on link investment goals - Navigate to page investor education investing goals.png')
...
"Step 8: Click on button viewAllInvestmentOptions (ViewAllRetirement) -> Navigate to page 'investing goals#*/*/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 8-Click on button viewAllInvestmentOptions ViewAllRetirement - Navigate to page investing goals.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 9-Click on link investingGoals RetirementIncomeOptions - Navigate to page insights articles.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Beginner Investment Education and Tools Navigation_visual_checkpoint')
