...
"Step 4: Navigate and enter user financial data in forms"
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 6-Click on link navigation Next.png')
...
"Step 9: Click on link generate pdf -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/retirementcalculator?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_calculator_page/link_generate_pdf'))

WebUI.takeScreenshot(reportLocation + '/TC29/Step 9-Click on link generate pdf - Navigate to page .png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC29-Plan Retirement with User Financial Data_visual_checkpoint')
