...
"Step 3: Click on span dollarAmount (NominalDollars)"
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 3-Click on span dollarAmount NominalDollars.png')

"Step 4: Click on input dollarAmount (NominalDollars2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/growthcalculator?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_calculator_page/input_dollarAmount'))

WebUI.takeScreenshot(reportLocation + '/TC14/Step 4-Click on input dollarAmount NominalDollars2.png')
...
"Step 10: Enter input value in textbox first name"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_investor_education_ditching_debt/textbox_first_name'), textbox_first_name)

WebUI.takeScreenshot(reportLocation + '/TC14/Step 10-Enter input value in textbox first name.png')
...
"Step 12: Enter input value in textbox last name"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_investor_education_ditching_debt/textbox_last_name'), textbox_last_name)

WebUI.takeScreenshot(reportLocation + '/TC14/Step 12-Enter input value in textbox last name.png')
...
"Step 14: Select option with input value from combobox preferred language"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

TrueTestScripts.selectOptionByValue(findTestObject('AI-Generated/Page_investor_education_ditching_debt/combobox_preferred_language'), combobox_preferred_language)

WebUI.takeScreenshot(reportLocation + '/TC14/Step 14-Select option with input value from combobox preferred language.png')

"Step 15: Click on role radio"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_investor_education_ditching_debt/role_radio'))

WebUI.takeScreenshot(reportLocation + '/TC14/Step 15-Click on role radio.png')

"Step 16: Click on combobox description"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_investor_education_ditching_debt/combobox_description'))

WebUI.takeScreenshot(reportLocation + '/TC14/Step 16-Click on combobox description.png')

"Step 17: Select option with input value from combobox description"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

TrueTestScripts.selectOptionByValue(findTestObject('AI-Generated/Page_investor_education_ditching_debt/combobox_description'), combobox_description)

WebUI.takeScreenshot(reportLocation + '/TC14/Step 17-Select option with input value from combobox description.png')
...
"Step 19: Click on checkbox consent"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_investor_education_ditching_debt/checkbox_consent'))

WebUI.takeScreenshot(reportLocation + '/TC14/Step 19-Click on checkbox consent.png')

"Step 20: Click on button get the guide"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_investor_education_ditching_debt/button_get_the_guide'))

WebUI.takeScreenshot(reportLocation + '/TC14/Step 20-Click on button get the guide.png')

"Step 21: Click on link editorial card -> Navigate to page 'investor education save or invest#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_investor_education_ditching_debt/link_editorial_card'))

WebUI.takeScreenshot(reportLocation + '/TC14/Step 21-Click on link editorial card - Navigate to page investor education save or invest.png')

"Step 22: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Get Guide for Personal Finance Management_visual_checkpoint')
