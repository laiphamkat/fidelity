...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 2-Click on fundSearchInput.png')

"Step 3: Hover over tr object3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/priceandperformance?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_generic_page/tr_object3'))

WebUI.takeScreenshot(reportLocation + '/TC27/Step 3-Hover over tr object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 4-Enter input value in fundSearchInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 5-Click on americanEquityLink - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC27-Search for Funds in Price and Performance Section_visual_checkpoint')
