...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 2-Click on searchInputField.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 3-Hover over tr object.png')

"Step 4: Enter input value in searchInputField"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_fund_information/searchInputField'), searchInputField)

WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Enter input value in searchInputField.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 5-Click on fidelityCanadianAssetAllocationFundLink - Navigate to page product listingproducts.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 6-Click on seriesBDropdown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 7-Click on seriesBOption - Navigate to page fund information.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 8-Hover over tr object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 9-Click on linkOptionB - Navigate to page .png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Search Fund Information and Navigate to Product Listing_visual_checkpoint')
