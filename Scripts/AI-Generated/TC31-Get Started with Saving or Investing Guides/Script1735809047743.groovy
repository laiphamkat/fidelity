...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 2-Click on link growth calculator - Navigate to page calculator pagegrowthcalculator.png')

"Step 3: Click on nominalDollarsOption22"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/growthcalculator?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_calculator_page/nominalDollarsOption22'))

WebUI.takeScreenshot(reportLocation + '/TC31/Step 3-Click on nominalDollarsOption22.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 4-Click on input nominalDollars NominalDollars2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 5-Click on link years - Navigate to page investor education ditching debt.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 6-Click on link get started.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 7-Click on input email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 8-Enter input value in input email2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 9-Click on textbox first name.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 10-Enter input value in textbox first name2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 11-Click on textbox last name.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 12-Enter input value in textbox last name2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 13-Click on combobox preferred language.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 14-Click on role radio.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 15-Click on combobox description.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 16-Click on button get the guide.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 17-Click on checkbox consent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 18-Click on button get the guide.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 19-Click on link editorial card - Navigate to page investor education save or invest.png')

"Step 20: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC31-Get Started with Saving or Investing Guides_visual_checkpoint')
