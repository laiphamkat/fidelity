...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 2-Click on link fd-megamenu--desktop  subject - Navigate to page generic pagepriceandperformance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 3-Click on link insights - Navigate to page educational content.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 4-Click on link about us - Navigate to page informational pageaboutus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 5-Click on link proxy voting - Navigate to page generic proxyproxy.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC17-Explore ETF Options and Educational Resources_visual_checkpoint')
