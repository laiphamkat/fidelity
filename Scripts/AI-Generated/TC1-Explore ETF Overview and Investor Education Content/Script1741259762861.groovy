...
"Step 2: Click on link ETFsOverview -> Navigate to page 'investment etfs#*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_homepage/link_ETFsOverview'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 2-Click on link ETFsOverview - Navigate to page investment etfs.png')

"Step 3: Hover over div investmentETFs"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_investment_etfs/div_investmentETFs'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 3-Hover over div investmentETFs.png')
...
"Step 5: Hover over div whatIsETF"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.mouseOver(findTestObject('AI-Generated/Page_investor_education_what_is_an_etf/div_whatIsETF'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 5-Hover over div whatIsETF.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Explore ETF Overview and Investor Education Content_visual_checkpoint')
