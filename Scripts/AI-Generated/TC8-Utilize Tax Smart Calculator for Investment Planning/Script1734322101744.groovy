...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 2-Click on addFundsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 3-Click on fundNameInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Enter input value in fundNameInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 5-Click on closeDialogButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 6-Click on taxSmartCalculatorLink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 7-Click on addFundsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 8-Click on closeDialogButton2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 9-Click on investmentFinderLink - Navigate to page investment finder.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 10-Click on taxSmartCalculatorLink - Navigate to page calculator pagetaxsmartcalculator.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 11-Click on addFundsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 12-Click on closeDialogButton2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 13-Click on monthlyPreTaxCashFlow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 14-Click on monthlyPreTaxCashFlow2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 15-Click on investmentInTSeries.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 16-Click on addFundsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 17-Click on categorySelectElement.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 18-Click on fundNameInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 19-Enter input value in fundNameInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 20-Click on fidelityBalancedClassPortfolioCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 21-Click on addSelectedFundsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 22-Click on fundAllocationPercentageInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 23-Enter input value in fundAllocationPercentageInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 24-Click on taxProvinceSelector.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 25-Click on calculateButton.png')

"Step 26: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Utilize Tax Smart Calculator for Investment Planning_visual_checkpoint')
