...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 2-Click on priceAndPerformanceLink - Navigate to page generic pagepriceandperformance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 3-Click on insightsLink - Navigate to page educational content.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 4-Click on aboutUsLink - Navigate to page informational pageaboutus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 5-Click on proxyVotingLink - Navigate to page generic proxyproxy.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC17-Access ETF Insights and Proxy Voting Information_visual_checkpoint')
