...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 2-Click on investingForBeginnersLink - Navigate to page investor education investing beginners.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 3-Click on whatIsAStockLink - Navigate to page investor education.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 5-Click on investorEducationLink - Navigate to page educational content.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 6-Click on sixTipsForRRSP - Navigate to page insights articles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 7-Click on investmentGoalsLink - Navigate to page investor education investing goals.png')
...
"Step 9: Click on button viewAllGoals (ViewAllEducation) -> Navigate to page 'investing goals#*/*/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 9-Click on button viewAllGoals ViewAllEducation - Navigate to page investing goals.png')

"Step 10: Click on link investingOptions (IntroductionToRESPs) -> Navigate to page 'insights articles#*/*/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 10-Click on link investingOptions IntroductionToRESPs - Navigate to page insights articles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 11-Click on investmentStartGuideLink - Navigate to page investor education.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 12-Click on financialGoalsLink - Navigate to page dream acceleration page.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 13-Click on learnMoreButton - Navigate to page guideshowtobuyfidelityfunds.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 14-Click on searchETFsOrMutualFundsLink - Navigate to page investment finder.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 15-Click on managedPortfoliosCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 16-Click on managedPortfoliosCheckbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 17-Click on clearPathRetirementPortfoliosCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 18-Click on privateInvestmentPoolsCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 19-Click on etfSelectionCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 21-Click on clearPathRetirementPortfoliosCheckbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 22-Click on privateInvestmentPoolsCheckbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 40-Click on div ManagedPortfolios.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 41-Click on div ManagedPortfolios2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 42-Click on div ManagedPortfolios3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 43-Click on div ManagedPortfolios4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 44-Click on div ManagedPortfolios3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 45-Click on div ClearPathRetirement.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 46-Click on div ClearPathRetirementPortfolios.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 47-Click on div ClearPathRetirement2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 48-Click on div ClearPathRetirementPortfolios2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 49-Click on div PrivateInvestmentPools.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 50-Click on div PrivateInvestmentPools2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 53-Click on div ClearPathRetirement.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 54-Click on div PrivateInvestmentPools.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 55-Click on div PrivateInvestmentPools3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 56-Click on div ClearPathRetirementPortfolios3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 57-Click on div ManagedPortfolios5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 62-Click on div ManagedPortfolios6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 63-Click on div ClearPathRetirement3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 64-Click on div PrivateInvestmentPools4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 65-Click on div PrivateInvestmentPools5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 66-Click on div PrivateInvestmentPools6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 67-Click on div PrivateInvestmentPools5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 68-Click on div PrivateInvestmentPools6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 69-Click on div PrivateInvestmentPools5.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Investment Finder and Portfolio Selection Process_visual_checkpoint')
