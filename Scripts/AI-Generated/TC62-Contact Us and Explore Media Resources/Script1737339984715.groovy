...
WebUI.takeScreenshot(reportLocation + '/TC62/Step 2-Click on link about us - Navigate to page informational pageaboutus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC62/Step 3-Click on link contact us - Navigate to page contact pagecontact.png')
...
WebUI.takeScreenshot(reportLocation + '/TC62/Step 4-Click on button send email.png')

"Step 5: Click on link careers"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/contact?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_contact_page/link_careers_1'))

WebUI.takeScreenshot(reportLocation + '/TC62/Step 5-Click on link careers.png')

"Step 6: Click on link media centre -> Navigate to page 'media resources#*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/contact?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_contact_page/link_media_centre_1'))

WebUI.takeScreenshot(reportLocation + '/TC62/Step 6-Click on link media centre - Navigate to page media resources.png')
...
WebUI.takeScreenshot(reportLocation + '/TC62/Step 7-Click on span object - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC62-Contact Us and Explore Media Resources_visual_checkpoint')
