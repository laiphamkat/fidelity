...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 2-Click on button None.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 3-Click on link Deposit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 4-Click on button Monthly.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 5-Click on link Annually - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Navigate to Products and Verify Homepage_visual_checkpoint')
