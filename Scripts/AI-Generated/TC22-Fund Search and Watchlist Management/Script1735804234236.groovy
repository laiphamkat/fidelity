...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 2-Click on etfSelectionCheckbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 3-Click on checkbox managed portfolios3.png')

"Step 4: Click on fundSearchInput2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_investment_finder/fundSearchInput2'))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 4-Click on fundSearchInput2.png')

"Step 5: Enter input value in combobox fund search"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_investment_finder/fundSearchInput2'), combobox_fund_search)

WebUI.takeScreenshot(reportLocation + '/TC22/Step 5-Enter input value in combobox fund search.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 6-Click on item InvestmentListItem.png')

"Step 7: Enter input value in combobox fund search"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_investment_finder/fundSearchInput2'), combobox_fund_search_1)

WebUI.takeScreenshot(reportLocation + '/TC22/Step 7-Enter input value in combobox fund search.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 8-Click on fidelityAdvantageBitcoinETFFundOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 9-Click on span AssetClassLabel.png')

"Step 10: Click on md selectOptions (SelectOption14)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_investment_finder/md_selectOptions'))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 10-Click on md selectOptions SelectOption14.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 11-Click on md Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 12-Click on span AssetCategoryLabel.png')

"Step 13: Click on md selectOptions (SelectOption27)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_investment_finder/md_selectOptions'))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 13-Click on md selectOptions SelectOption27.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 14-Click on md Backdrop.png')
...
"Step 16: Click on md selectOptions (SelectOption43)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_investment_finder/md_selectOptions'))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 16-Click on md selectOptions SelectOption43.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 17-Click on md Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 18-Click on viewFundsLink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 19-Click on addToWatchlistButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 20-Click on closeButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 21-Click on fidelityAdvantageEtherETF - Navigate to page product listingproducts.png')

"Step 22: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Fund Search and Watchlist Management_visual_checkpoint')
